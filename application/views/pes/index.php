    ...
    <div class="container mt-5 mb-5">
      <div class="row">
        <div class="col-md mt-5">
          <h3 class="judulnya text-center">Daftar kompetisi PES</h3>
        </div>
      </div>
              ...
              <div class="row mt-2">
                <div class="col-md">
                  <div class="alert alert-warning text-left" role="alert">
                    ...
                    1.081362975615 (An Naldy) <br>
                    2.082274040496 (An Jhon) <br>
                    Kirim foto struk bukti transfer dengan format (nama),(PES) ke salah satu nomor panitia diatas<br>
                    contoh : foto (Andi),(PES)
                  </div>
                </div>
              </div>
            </form>
