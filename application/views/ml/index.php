    ...
    <div class="container mt-5 mb-5">
      <div class="row">
        <div class="col-md mt-5">
          <h3 class="judulnya text-center">Daftar kompetisi Mobile Legend</h3>
        </div>
      </div>
          ...
          <div class="col-md">
            <form action="" method="post">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="nama_tim" id="nama_tim" value="<?= set_value('nama_tim') ?>" placeholder="Nama Team....">
                <?= form_error('nama_tim', '<p class="text-danger">', '</p>'); ?>
              </div>
              <div class="form-group">
                <label for="nama_leader">Nama Leader</label>
                <input type="text" class="form-control" name="nama_leader" id="nama_leader" value="<?= set_value('nama_leader') ?>" placeholder="Nama Leader....">
                <?= form_error('nama_leader', '<p class="text-danger">', '</p>'); ?>
              </div>
              <div class="form-group">
                <label for="phone">Nomor Hp Leader</label>
              ...
              <div class="form-group">
                <label for="nama_anggota">Nama nama anggota</label>
                <textarea name="nama_anggota" id="nama_anggota" class="form-control" rows="6" placeholder="1.
2.
3.
4.
5."><?= set_value('nama_anggota') ?></textarea>
                <?= form_error('nama_anggota', '<p class="text-danger">', '</p>'); ?>
              </div>
              <div class="form-group">
                <label for="nama_nick">Nama nama nickname</label>
                <textarea name="nama_nick" id="nama_nick" class="form-control" rows="6" placeholder="1.
2.
3.
4.
5."><?= set_value('nama_nick') ?></textarea>
                <?= form_error('nama_nick', '<p class="text-danger">', '</p>'); ?>
              </div>
              ...
              <div class="row mt-2">
                <div class="col-md">
                  <div class="alert alert-warning text-left" role="alert">
                    Setelah melakukan pendaftaran, silahkan melakukan transfer sebesar Rp.100.000,- <br>
                    ...
                    1.+62 823-6625-7568 (An Fourman) <br>
                    2.+62 852-6550-8841 (An Naek) <br>
                    Kirim foto struk bukti transfer dengan format (nama),(Mobile legend) ke salah satu nomor panitia diatas<br>
                    contoh : foto (Andi),(Mobile Legend)
                  </div>
                </div>
              </div>
            </form>
