          ...
          <div class="jumbotronx width">
            <div class="row">
              <div class="col-md-7">
                ...
                <p class="paragraph pl-5 text-center">Aplikasi ini adalah aplikasi Pengolahan Data IT COMPETITION</p>
                <p class="paragraph pl-5 text-center">Silahkan klik disini untuk memulai aplikasi </p>
                <a href="<?= base_url('mobile_legend') ?>" class="btn btn-primary tombol">Klik Disini</a>
              </div>
              <div class="col-md-5">
                <img src="<?= base_url('asets/images/fikom.png') ?>" class="gambar-kanan hilang">
              </div>
            </div>
          </div>
