    ...
    <div class="container mt-5 mb-5">
      <div class="row">
        <div class="col-md mt-5">
          <h3 class="judulnya text-center">Daftar kompetisi Fotografi</h3>
        </div>
      </div>
          ...
          <div class="col-md">
            <form action="" method="post">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="nama" id="nama" value="<?= set_value('nama') ?>" placeholder="Nama Peserta....">
              ...
              <div class="row mt-2">
                <div class="col-md">
                  <div class="alert alert-warning text-left" role="alert">
                    Setelah melakukan pendaftaran, silahkan melakukan transfer sebesar Rp.50.000,- <br>
                    ...
                    1.081260474419 (An Mitha) <br>
                    2.0852619023355 (An Mario) <br>
                    Kirim foto struk bukti transfer dengan format (nama),(Fotografi) ke salah satu nomor panitia diatas<br>
                    contoh : foto (Andi),(Fotografi)
                  </div>
                </div>
              </div>
            </form>
